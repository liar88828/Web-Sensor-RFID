...
import {SensorProfile, TableSensorProfile} from "@/app/(sites)/(admin)/user/profile/components/SensorProfile";
import RecordProfile from "@/app/(sites)/(admin)/user/profile/components/RecordProfile";
import type {DataProfile} from "@/interface/profile/example1";
import {AnggotaProfile} from "@/app/(sites)/(admin)/user/profile/components/AnggotaProfile";
