    ...
    <>
      <Container className="flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap  ">
        <div
          ...
          <div className={'bg-base-300/10  flex    backdrop-blur-md static rounded-xl'}>
            <Image
              src={data.image}
              width="521"
              // height="auto"
...
function Benefit({icon, children, title}: { icon: ReactElement<any>, children: ReactNode, title: string }) {
  return (
    <>
