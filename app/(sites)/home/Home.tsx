...
const Hero = dynamic(
  () => import("@/app/(sites)/home/components/hero")
  , {loading: () => <p>Loading...</p>,})

const SectionTitle = dynamic(
  () => import("@/app/(sites)/home/components/sectionTitle")
  , {loading: () => <p>Loading...</p>,})

const Benefits = dynamic(
  () => import("@/app/(sites)/home/components/benefits")
  , {loading: () => <p>Loading...</p>,})


const Video = dynamic(
  () => import("@/app/(sites)/home/components/video")
  , {loading: () => <p>Loading...</p>,})

const Testimonials = dynamic(
  () => import("@/app/(sites)/home/components/testimonials")
  , {loading: () => <p>Loading...</p>,})

const Cta = dynamic(
  () => import("@/app/(sites)/home/components/cta")
  , {loading: () => <p>Loading...</p>,})

const Footer = dynamic(
  () => import("@/app/(sites)/dashboard/components/Footer")
  , {loading: () => <p>Loading...</p>,})
